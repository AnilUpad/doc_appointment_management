...
def showinsert():
    ...
    def insertdata():
        if len(e1.get())==0:
            ...
            sql="insert into patients values(%d,'%s','%s','%s','%s','%s','%s','%s')"%(xb,xc,xd,xe,xf,xg,xh,xi)
            cur.execute(sql)
            db.commit()
    ...
    c = Label(t,text='pname',fg='red',bg='yellow')
    c.place(x=50,y=160)
    e2 = Entry(t,width=30)
    ...
    e = Label(t,text='phone',fg='red',bg='yellow')
    e.place(x=50,y=240)
    e4 = Entry(t,width=30)
    ...
    g = Label(t,text='doctorid',fg='red',bg='yellow')
    g.place(x=50,y=320)
    e6 = Entry(t,width=30)
    e6.place(x=200,y=320)
    
    
    h = Label(t,text='problem',fg='red',bg='yellow')
    h.place(x=50,y=360)
    e7 = Entry(t,width=30)
    e7.place(x=200,y=360)
    
    i = Label(t,text='remarks',fg='red',bg='yellow')
    i.place(x=50,y=400)
    e8 = Entry(t,width=30)
